describe('Unit: googleAppsFormPluginContent: Services', function () {
  ...
  describe('Unit : DataStore Factory', function () {
    ...
    beforeEach(module('googleAppsFormPluginContent', function ($provide) {
    ...
    it('DataStore.update should return success', function () {
      ...
      DataStore.update(123, TAG_NAMES.GOOGLE_FORM_INFO, null).then(success, error);
      $rootScope.$digest();
      expect(result).toEqual('Success');
    });
    ...
    it('DataStore.save should return success', function () {
      ...
      DataStore.save(123, TAG_NAMES.GOOGLE_FORM_INFO, null).then(success, error);
      $rootScope.$digest();
      expect(result).toEqual('Success');
    });
  });
  ...
  describe('Unit : Utils Factory', function () {
    ...
    it('Utils.validateUrl should exist and be a function', function () {
      expect(typeof Utils.validateUrl).toEqual('function');
    });
    it('Utils.validateUrl should return error', function () {
      var result = Utils.validateUrl('http://localhost:63342/googleAppsFormPlugin/test/cjjj');
      expect(result).toEqual(false);
    });
    it('Utils.validateUrl should return success', function () {
      var result = Utils.validateUrl('https://docs.google.com/a/tothenew.com/forms/d/1DIjTXFO5z4C1AGfxtUnAljunnkl4P7yZsmDPIxDXhKE/edit');
